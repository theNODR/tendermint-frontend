...
<script>
  ...
  //     // }
  //     // setInterval(() => {
  //     //   this.statDetails = this.tlprt && this.tlprt.getStatDetails()
  //     // }, 1000)
  //   },
    // activated() {
    //   document.getElementById('video').play()
  ...
  //         .then((instance) => {
  //           this.tlprt = instance;
  //           this.tlprt.onPeerConnectionOpened = (peerId) => { 
  //             if (this.peerListConnected.indexOf(peerId) === -1) {
  //               this.peerListConnected.push(peerId);
  //             }
  //           }
  //           this.tlprt.onPeerConnectionClosed = (peerId) => {
  ...
  //         })
  //         setInterval(() => {
  //           this.statDetails = this.tlprt.getStatDetails()
  //         }, 1000)
  //         // setInterval(() => {
